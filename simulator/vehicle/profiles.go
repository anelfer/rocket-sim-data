...
var profiles = map[string]Profile{
	...
	"starship": {
		...
		Notes: []string{
			...
			"Возврат ступеней, перехват стартовым сооружением и заправка " +
				"на орбите не моделируются: обе ступени летят как одноразовые.",
			...
			"Открытые данные по третьему блоку расходятся: стартовую массу " +
				"называют от 5250 до 5375 т, суммарную тягу — от 80.8 до " +
				"90.6 МН. Взят внутренне согласованный набор, тяга считается " +
				"моделью из давления и геометрии сопла.",
		},
